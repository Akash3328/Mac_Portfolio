...
// const WindowWrapper = (Component, windowKey) => {
//   const Wrapped = (props) => {
//     const { focusWindow, windows, activeWindow } = useWindowStore(); // 🔥 CHANGED
...
//       gsap.to(el, {
//         boxShadow: isActive
//           ? "0 0 0 1px rgba(255,255,255,0.15), 0 30px 80px rgba(0,0,0,0.45)"
//           : "0 12px 30px rgba(0,0,0,0.35)",
//         duration: 0.25,
//         ease: "power2.out",
//       });
//     }, [activeWindow]); // 🔥 reacts when focus changes
...
//       const [instance] = Draggable.create(el, {
//         onPress: () => focusWindow(windowKey), // 🔥 focus on drag
//       });
...
//         onMouseDown={() => focusWindow(windowKey)} // 🔥 focus on click
//       >
//         <Component {...props} />
//       </section>
//     );
